...
## Now align the data
mfa align --phone_groups_path scripts/alignment_data/phone_groups.yaml --speaker_characters 3 --g2p_model_path output/models/g2p.zip -j8 output/arranged_corpus scripts/alignment_data/word2pron.txt output/models/am.zip output/alignment
